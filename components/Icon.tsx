...
export const LeafIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 0 0 9-9h-9v9ZM12 3a9 9 0 0 1 9 9h-9V3Z" />
    </svg>
);
...
export const CarbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5c0-.966.784-1.75 1.75-1.75h1.5a1.75 1.75 0 0 0 1.75-1.75v-1.5a1.75 1.75 0 0 0-1.75-1.75h-1.5a1.75 1.75 0 0 0-1.75-1.75V3m-4.5 0v3.75c0 .966-.784 1.75-1.75 1.75h-1.5A1.75 1.75 0 0 1 3.75 7.5v-1.5A1.75 1.75 0 0 1 5.5 4.25h1.5A1.75 1.75 0 0 1 9 3m4.5 0h.008v.008H13.5V3Zm-4.5 0h.008v.008H9V3Z" />
    </svg>
);
